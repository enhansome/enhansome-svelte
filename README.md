...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 87,989 | 🐛 1,054 | 🌐 JavaScript | 📅 2026-08-25
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 87,989 | 🐛 1,054 | 🌐 JavaScript | 📅 2026-08-25
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,899 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-24 - Svelte implementation of the IBM Carbon Design System.
...
* [Svelte UX](https://github.com/techniq/svelte-ux) ⭐ 1,128 | 🐛 116 | 🌐 Svelte | 📅 2026-08-23 - Large collection of components, actions, stores, and utilities to build highly interactive applications
...
* [svelte-datagrid](https://github.com/revolist/svelte-datagrid) ⭐ 140 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - Powerful data grid library based on [revogrid](https://rv-grid.com) with best features from Excel.
...
* [svelte-sonner](https://github.com/wobsoriano/svelte-sonner) ⭐ 1,289 | 🐛 19 | 🌐 Svelte | 📅 2026-08-14 - An opinionated toast component for Svelte.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,166 | 🐛 558 | 🌐 TypeScript | 📅 2026-08-25 - Implementation of the lucide icon library for svelte applications.
...
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,615 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-25 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,538 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - A material design event calendar library.
...
* [Layer Cake](https://github.com/mhkeller/layercake) ⭐ 1,788 | 🐛 8 | 🌐 Svelte | 📅 2026-08-23 - A framework for mostly-reusable graphics with svelte
* [LayerChart](https://github.com/techniq/layerchart) ⭐ 1,305 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-25 - Large collection of composable Svelte components to build a wide range of visualizations, built upon Layer Cake
...
* [SVAR Gantt Chart](https://github.com/svar-widgets/gantt) ⭐ 252 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-29 - An interactive, customizable Gantt chart component written in Svelte
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,649 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-18 - A component to transition, format, and localize numbers.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,533 | 🐛 758 | 🌐 TypeScript | 📅 2026-08-25 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,764 | 🐛 844 | 🌐 JavaScript | 📅 2026-08-25 - A CLI for creating a new SvelteKit project.
...
* [wuchale](https://github.com/K1DV5/wuchale) ⭐ 399 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25 - Internationalization library that lets you just write your code, no function calls or other ceremonies needed.
...
* [svelte-fluent](https://github.com/nubolab-ffwd/svelte-fluent) ⭐ 113 | 🐛 12 | 🌐 Svelte | 📅 2026-08-25 - Components for easy integration of [Fluent](https://projectfluent.org/) localization.
...
* [sv-router](https://github.com/colinlienard/sv-router) ⭐ 211 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-25 - Type-safe SPA router with file-based or code-based routing.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 677 | 🐛 237 | 🌐 ReScript | 📅 2026-08-25 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 401 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-25 - An ESLint plugin for Svelte using AST.
