...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,172 | 🐛 1,093 | 🌐 JavaScript | 📅 2026-09-22
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,172 | 🐛 1,093 | 🌐 JavaScript | 📅 2026-09-22
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,909 | 🐛 116 | 🌐 TypeScript | 📅 2026-09-23 - Svelte implementation of the IBM Carbon Design System.
...
* [AgentsKit](https://github.com/AgentsKit-io/agentskit) ⭐ 27 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21 - Headless chat and agent components plus a store for building AI apps in Svelte, with a framework-agnostic core supporting streaming, tools, memory and RAG.
...
* [svelte-sonner](https://github.com/wobsoriano/svelte-sonner) ⭐ 1,294 | 🐛 21 | 🌐 Svelte | 📅 2026-08-14 - An opinionated toast component for Svelte.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,673 | 🐛 457 | 🌐 TypeScript | 📅 2026-09-22 - Implementation of the lucide icon library for svelte applications.
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,939 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-11 - Access thousands of icons as components on-demand universally.
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,720 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-23 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [moving icons](https://github.com/jis3r/icons) ⭐ 459 | 🐛 6 | 🌐 Svelte | 📅 2026-09-15 - A collection of beautifully crafted, animated Lucide icons.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,583 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-22 - A material design event calendar library.
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,711 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-20 - A component to transition, format, and localize numbers.
* [File Viewer](https://github.com/flyfish-dev/file-viewer/tree/main/packages/components/svelte) ⭐ 2,413 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-23 - An offline-first Svelte component that previews 206 file extensions with lazy renderer presets and no server-side conversion.
...
* [svelte-streamdown](https://github.com/beynar/svelte-streamdown) ⭐ 105 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-14 - Port of [streamdown](https://streamdown.ai/). An all in one markdown renderer optimized for streaming with built in styles, math, mermaid, code highlighting support and more.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,954 | 🐛 794 | 🌐 TypeScript | 📅 2026-09-22 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,823 | 🐛 803 | 🌐 JavaScript | 📅 2026-09-22 - A CLI for creating a new SvelteKit project.
...
* [moving-icons](https://github.com/jis3r/icons) ⭐ 459 | 🐛 6 | 🌐 Svelte | 📅 2026-09-15 - beautifully crafted, moving icons. for svelte. 🧡
...
* [neodrag](https://github.com/PuruVJ/neodrag) ⭐ 2,453 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-10 - One Draggable to rule them all 💍.
...
* [@stitchapi/svelte](https://github.com/rejifald/StitchAPI/tree/main/packages/svelte) ⭐ 18 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-21 - Streaming-first StitchAPI bindings: typed, validated `stitchStore` / `stitchStreamStore` Svelte stores that re-render as response deltas arrive.
...
* [sveltekit-i18n](https://github.com/jarda-svoboda/sveltekit-i18n) ⭐ 576 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-22 - For integrating [i18n](https://www.npmjs.com/package/i18n) style localization in SvelteKit.
...
* [@tolgee/svelte](https://github.com/tolgee/tolgee-js/tree/main/packages/svelte) ⭐ 260 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-22 - Web-based localization tool enabling users to translate directly in the Svelte app they develop.
* [svelte-fluent](https://github.com/nubolab-ffwd/svelte-fluent) ⭐ 113 | 🐛 13 | 🌐 Svelte | 📅 2026-09-22 - Components for easy integration of [Fluent](https://projectfluent.org/) localization.
...
* [svelte-spa-router](https://github.com/ItalyPaleAle/svelte-spa-router) ⭐ 1,610 | 🐛 21 | 🌐 Svelte | 📅 2026-08-23 - Optimized for Single Page Applications (SPA) with hash based routing and support for parameters.
...
* [sv-router](https://github.com/colinlienard/sv-router) ⭐ 216 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-23 - Type-safe SPA router with file-based or code-based routing.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 705 | 🐛 247 | 🌐 ReScript | 📅 2026-09-21 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 408 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-20 - An ESLint plugin for Svelte using AST.
...
* [PR Cockpit](https://github.com/theolundqvist/pr-cockpit) ⭐ 47 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-22 - An extremely fast GitHub for reviewing pull requests: PRs open in about 20 ms. Keyboard-first, with a CLI for coding agents. Svelte 5 runes UI over a Bun server.
