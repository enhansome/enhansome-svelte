...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,132 | 🐛 1,081 | 🌐 JavaScript | 📅 2026-09-16
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,132 | 🐛 1,081 | 🌐 JavaScript | 📅 2026-09-16
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,908 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-18 - Svelte implementation of the IBM Carbon Design System.
...
* [svelte-sonner](https://github.com/wobsoriano/svelte-sonner) ⭐ 1,292 | 🐛 21 | 🌐 Svelte | 📅 2026-08-14 - An opinionated toast component for Svelte.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,568 | 🐛 459 | 🌐 TypeScript | 📅 2026-09-17 - Implementation of the lucide icon library for svelte applications.
...
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,702 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-18 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [svelte-icons-pack](https://github.com/leshak/svelte-icons-pack) ⭐ 72 | 🐛 1 | 🌐 TypeScript | 📅 2024-03-27 - Based on <https://github.com/react-icons/react-icons> ⭐ 12,658 | 🐛 244 | 🌐 TypeScript | 📅 2026-09-11.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,573 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-16 - A material design event calendar library.
...
* [LayerChart](https://github.com/techniq/layerchart) ⭐ 1,322 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-09 - Large collection of composable Svelte components to build a wide range of visualizations, built upon Layer Cake
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,699 | 🐛 20 | 🌐 TypeScript | 📅 2026-07-18 - A component to transition, format, and localize numbers.
* [File Viewer](https://github.com/flyfish-dev/file-viewer/tree/main/packages/components/svelte) ⭐ 2,344 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-14 - An offline-first Svelte component that previews 206 file extensions with lazy renderer presets and no server-side conversion.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,862 | 🐛 785 | 🌐 TypeScript | 📅 2026-09-17 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,812 | 🐛 808 | 🌐 JavaScript | 📅 2026-09-18 - A CLI for creating a new SvelteKit project.
...
* [sveltekit-i18n](https://github.com/jarda-svoboda/sveltekit-i18n) ⭐ 575 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-17 - For integrating [i18n](https://www.npmjs.com/package/i18n) style localization in SvelteKit.
* [wuchale](https://github.com/K1DV5/wuchale) ⭐ 409 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-17 - Internationalization library that lets you just write your code, no function calls or other ceremonies needed.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 699 | 🐛 237 | 🌐 ReScript | 📅 2026-09-17 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 407 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-10 - An ESLint plugin for Svelte using AST.
