...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,012 | 🐛 1,054 | 🌐 JavaScript | 📅 2026-08-29
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,012 | 🐛 1,054 | 🌐 JavaScript | 📅 2026-08-29
...
* [Svelte UX](https://github.com/techniq/svelte-ux) ⭐ 1,128 | 🐛 116 | 🌐 Svelte | 📅 2026-08-29 - Large collection of components, actions, stores, and utilities to build highly interactive applications
...
* [M3 Svelte](https://github.com/KTibow/m3-svelte) ⭐ 457 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-18 - Robust component library implementing Material Design 3
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,228 | 🐛 523 | 🌐 TypeScript | 📅 2026-08-28 - Implementation of the lucide icon library for svelte applications.
...
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,622 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-25 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [moving icons](https://github.com/jis3r/icons) ⭐ 452 | 🐛 6 | 🌐 Svelte | 📅 2026-08-23 - A collection of beautifully crafted, animated Lucide icons.
...
* [svelte-icons-pack](https://github.com/leshak/svelte-icons-pack) ⭐ 71 | 🐛 1 | 🌐 TypeScript | 📅 2024-03-27 - Based on <https://github.com/react-icons/react-icons> ⭐ 12,625 | 🐛 239 | 🌐 TypeScript | 📅 2026-08-12.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,544 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-28 - A material design event calendar library.
...
* [LayerChart](https://github.com/techniq/layerchart) ⭐ 1,308 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-27 - Large collection of composable Svelte components to build a wide range of visualizations, built upon Layer Cake
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,656 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-18 - A component to transition, format, and localize numbers.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,575 | 🐛 771 | 🌐 TypeScript | 📅 2026-08-28 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,766 | 🐛 822 | 🌐 JavaScript | 📅 2026-08-28 - A CLI for creating a new SvelteKit project.
...
* [moving-icons](https://github.com/jis3r/icons) ⭐ 452 | 🐛 6 | 🌐 Svelte | 📅 2026-08-23 - beautifully crafted, moving icons. for svelte. 🧡
...
* sveltednd(<https://github.com/thisuxhq/sveltednd> ⭐ 603 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31) - A lightweight, flexible drag and drop library for Svelte 5 applications.
...
* [wuchale](https://github.com/K1DV5/wuchale) ⭐ 399 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-28 - Internationalization library that lets you just write your code, no function calls or other ceremonies needed.
...
* [svelte-fluent](https://github.com/nubolab-ffwd/svelte-fluent) ⭐ 113 | 🐛 12 | 🌐 Svelte | 📅 2026-08-29 - Components for easy integration of [Fluent](https://projectfluent.org/) localization.
...
* [svelte-router-spa](https://github.com/jorgegorka/svelte-router) ⭐ 538 | 🐛 32 | 🌐 JavaScript | 📅 2024-06-18 - Router adds routing to your Single Page Applications (SPA). Includes localisation, guards and nested layouts.
...
* [sv-router](https://github.com/colinlienard/sv-router) ⭐ 211 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-28 - Type-safe SPA router with file-based or code-based routing.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 681 | 🐛 242 | 🌐 ReScript | 📅 2026-08-28 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
