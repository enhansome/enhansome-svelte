...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,173 | 🐛 1,097 | 🌐 JavaScript | 📅 2026-09-23
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,173 | 🐛 1,097 | 🌐 JavaScript | 📅 2026-09-23
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,909 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-24 - Svelte implementation of the IBM Carbon Design System.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,689 | 🐛 460 | 🌐 TypeScript | 📅 2026-09-22 - Implementation of the lucide icon library for svelte applications.
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,940 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-11 - Access thousands of icons as components on-demand universally.
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,724 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-23 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [moving icons](https://github.com/jis3r/icons) ⭐ 460 | 🐛 6 | 🌐 Svelte | 📅 2026-09-15 - A collection of beautifully crafted, animated Lucide icons.
...
* [svelte-icons-pack](https://github.com/leshak/svelte-icons-pack) ⭐ 73 | 🐛 1 | 🌐 TypeScript | 📅 2024-03-27 - Based on <https://github.com/react-icons/react-icons> ⭐ 12,669 | 🐛 245 | 🌐 TypeScript | 📅 2026-09-18.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,585 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-22 - A material design event calendar library.
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,712 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-20 - A component to transition, format, and localize numbers.
* [File Viewer](https://github.com/flyfish-dev/file-viewer/tree/main/packages/components/svelte) ⭐ 2,419 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-24 - An offline-first Svelte component that previews 206 file extensions with lazy renderer presets and no server-side conversion.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,968 | 🐛 796 | 🌐 TypeScript | 📅 2026-09-23 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,827 | 🐛 789 | 🌐 JavaScript | 📅 2026-09-24 - A CLI for creating a new SvelteKit project.
...
* [moving-icons](https://github.com/jis3r/icons) ⭐ 460 | 🐛 6 | 🌐 Svelte | 📅 2026-09-15 - beautifully crafted, moving icons. for svelte. 🧡
...
* [@tolgee/svelte](https://github.com/tolgee/tolgee-js/tree/main/packages/svelte) ⭐ 260 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-23 - Web-based localization tool enabling users to translate directly in the Svelte app they develop.
...
* [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 408 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-20 - An ESLint plugin for Svelte using AST.
...
* [PR Cockpit](https://github.com/theolundqvist/pr-cockpit) ⭐ 47 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-24 - An extremely fast GitHub for reviewing pull requests: PRs open in about 20 ms. Keyboard-first, with a CLI for coding agents. Svelte 5 runes UI over a Bun server.
