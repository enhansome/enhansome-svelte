...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,093 | 🐛 1,072 | 🌐 JavaScript | 📅 2026-09-10
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,093 | 🐛 1,072 | 🌐 JavaScript | 📅 2026-09-10
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,906 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-11 - Svelte implementation of the IBM Carbon Design System.
...
* [Svelte UX](https://github.com/techniq/svelte-ux) ⭐ 1,126 | 🐛 118 | 🌐 Svelte | 📅 2026-09-10 - Large collection of components, actions, stores, and utilities to build highly interactive applications
...
* [AgentsKit](https://github.com/AgentsKit-io/agentskit) ⭐ 25 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-10 - Headless chat and agent components plus a store for building AI apps in Svelte, with a framework-agnostic core supporting streaming, tools, memory and RAG.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,454 | 🐛 474 | 🌐 TypeScript | 📅 2026-09-11 - Implementation of the lucide icon library for svelte applications.
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,935 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-10 - Access thousands of icons as components on-demand universally.
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,681 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-08 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [svelte-icons-pack](https://github.com/leshak/svelte-icons-pack) ⭐ 72 | 🐛 1 | 🌐 TypeScript | 📅 2024-03-27 - Based on <https://github.com/react-icons/react-icons> ⭐ 12,652 | 🐛 242 | 🌐 TypeScript | 📅 2026-09-10.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,562 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-10 - A material design event calendar library.
...
* [LayerChart](https://github.com/techniq/layerchart) ⭐ 1,314 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-09 - Large collection of composable Svelte components to build a wide range of visualizations, built upon Layer Cake
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer/tree/main/packages/components/svelte) ⭐ 2,286 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-09 - An offline-first Svelte component that previews 206 file extensions with lazy renderer presets and no server-side conversion.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,780 | 🐛 755 | 🌐 TypeScript | 📅 2026-09-10 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,802 | 🐛 799 | 🌐 JavaScript | 📅 2026-09-10 - A CLI for creating a new SvelteKit project.
...
* [svelte-fluent](https://github.com/nubolab-ffwd/svelte-fluent) ⭐ 113 | 🐛 12 | 🌐 Svelte | 📅 2026-09-10 - Components for easy integration of [Fluent](https://projectfluent.org/) localization.
...
* [svelte5-router](https://github.com/mateothegreat/svelte5-router) ⭐ 309 | 🐛 26 | 🌐 TypeScript | 📅 2025-10-29 - First Svelte 5 SPA router with nesting, hooks, and more.. Use components, snippets, or both!
* [sv-router](https://github.com/colinlienard/sv-router) ⭐ 215 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-10 - Type-safe SPA router with file-based or code-based routing.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 692 | 🐛 235 | 🌐 ReScript | 📅 2026-09-10 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [PR Cockpit](https://github.com/theolundqvist/pr-cockpit) ⭐ 46 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-10 - An extremely fast GitHub for reviewing pull requests: PRs open in about 20 ms. Keyboard-first, with a CLI for coding agents. Svelte 5 runes UI over a Bun server.
