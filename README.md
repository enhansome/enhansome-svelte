...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,037 | 🐛 1,050 | 🌐 JavaScript | 📅 2026-08-31
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,037 | 🐛 1,050 | 🌐 JavaScript | 📅 2026-08-31
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,903 | 🐛 77 | 🌐 TypeScript | 📅 2026-08-31 - Svelte implementation of the IBM Carbon Design System.
...
* [AgentsKit](https://github.com/AgentsKit-io/agentskit) ⭐ 25 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-01 - Headless chat and agent components plus a store for building AI apps in Svelte, with a framework-agnostic core supporting streaming, tools, memory and RAG.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,261 | 🐛 527 | 🌐 TypeScript | 📅 2026-08-31 - Implementation of the lucide icon library for svelte applications.
...
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,630 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-31 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [moving icons](https://github.com/jis3r/icons) ⭐ 454 | 🐛 6 | 🌐 Svelte | 📅 2026-08-23 - A collection of beautifully crafted, animated Lucide icons.
...
* [svelte-icons-pack](https://github.com/leshak/svelte-icons-pack) ⭐ 71 | 🐛 1 | 🌐 TypeScript | 📅 2024-03-27 - Based on <https://github.com/react-icons/react-icons> ⭐ 12,627 | 🐛 239 | 🌐 TypeScript | 📅 2026-08-12.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,546 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-31 - A material design event calendar library.
...
* [SVAR Gantt Chart](https://github.com/svar-widgets/gantt) ⭐ 255 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-29 - An interactive, customizable Gantt chart component written in Svelte
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,661 | 🐛 20 | 🌐 TypeScript | 📅 2026-07-18 - A component to transition, format, and localize numbers.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,625 | 🐛 773 | 🌐 TypeScript | 📅 2026-08-31 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,773 | 🐛 828 | 🌐 JavaScript | 📅 2026-09-01 - A CLI for creating a new SvelteKit project.
...
* [moving-icons](https://github.com/jis3r/icons) ⭐ 454 | 🐛 6 | 🌐 Svelte | 📅 2026-08-23 - beautifully crafted, moving icons. for svelte. 🧡
...
* [wuchale](https://github.com/K1DV5/wuchale) ⭐ 401 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-31 - Internationalization library that lets you just write your code, no function calls or other ceremonies needed.
...
* [svelte-fluent](https://github.com/nubolab-ffwd/svelte-fluent) ⭐ 113 | 🐛 12 | 🌐 Svelte | 📅 2026-09-01 - Components for easy integration of [Fluent](https://projectfluent.org/) localization.
...
* [svelte-spa-router](https://github.com/ItalyPaleAle/svelte-spa-router) ⭐ 1,607 | 🐛 21 | 🌐 Svelte | 📅 2026-08-23 - Optimized for Single Page Applications (SPA) with hash based routing and support for parameters.
...
* [svelte5-router](https://github.com/mateothegreat/svelte5-router) ⭐ 308 | 🐛 26 | 🌐 TypeScript | 📅 2025-10-29 - First Svelte 5 SPA router with nesting, hooks, and more.. Use components, snippets, or both!
* [sv-router](https://github.com/colinlienard/sv-router) ⭐ 213 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-30 - Type-safe SPA router with file-based or code-based routing.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 682 | 🐛 241 | 🌐 ReScript | 📅 2026-08-31 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 404 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-26 - An ESLint plugin for Svelte using AST.
