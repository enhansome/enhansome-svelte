...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,135 | 🐛 1,082 | 🌐 JavaScript | 📅 2026-09-19
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,135 | 🐛 1,082 | 🌐 JavaScript | 📅 2026-09-19
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,908 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-19 - Svelte implementation of the IBM Carbon Design System.
...
* [Svelte UX](https://github.com/techniq/svelte-ux) ⭐ 1,126 | 🐛 118 | 🌐 Svelte | 📅 2026-09-17 - Large collection of components, actions, stores, and utilities to build highly interactive applications
...
* [AgentsKit](https://github.com/AgentsKit-io/agentskit) ⭐ 26 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-17 - Headless chat and agent components plus a store for building AI apps in Svelte, with a framework-agnostic core supporting streaming, tools, memory and RAG.
...
* [SVAR DataGrid](https://github.com/svar-widgets/grid) ⭐ 226 | 🐛 28 | 🌐 Svelte | 📅 2026-09-01 - A Svelte datagrid with in-cell editing, sorting, context menu, collapsible and frozen columns, tree data view, paging and virtual scrolling.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,593 | 🐛 458 | 🌐 TypeScript | 📅 2026-09-18 - Implementation of the lucide icon library for svelte applications.
...
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,706 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-18 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [svelte-icons-pack](https://github.com/leshak/svelte-icons-pack) ⭐ 72 | 🐛 1 | 🌐 TypeScript | 📅 2024-03-27 - Based on <https://github.com/react-icons/react-icons> ⭐ 12,659 | 🐛 245 | 🌐 TypeScript | 📅 2026-09-18.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,576 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-19 - A material design event calendar library.
...
* [LayerChart](https://github.com/techniq/layerchart) ⭐ 1,324 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-09 - Large collection of composable Svelte components to build a wide range of visualizations, built upon Layer Cake
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,702 | 🐛 20 | 🌐 TypeScript | 📅 2026-07-18 - A component to transition, format, and localize numbers.
* [File Viewer](https://github.com/flyfish-dev/file-viewer/tree/main/packages/components/svelte) ⭐ 2,350 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-18 - An offline-first Svelte component that previews 206 file extensions with lazy renderer presets and no server-side conversion.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,884 | 🐛 780 | 🌐 TypeScript | 📅 2026-09-19 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,818 | 🐛 809 | 🌐 JavaScript | 📅 2026-09-19 - A CLI for creating a new SvelteKit project.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,662 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-18 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [@stitchapi/svelte](https://github.com/rejifald/StitchAPI/tree/main/packages/svelte) ⭐ 18 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-17 - Streaming-first StitchAPI bindings: typed, validated `stitchStore` / `stitchStreamStore` Svelte stores that re-render as response deltas arrive.
...
* [wuchale](https://github.com/K1DV5/wuchale) ⭐ 409 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-18 - Internationalization library that lets you just write your code, no function calls or other ceremonies needed.
...
* [sv-router](https://github.com/colinlienard/sv-router) ⭐ 216 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-17 - Type-safe SPA router with file-based or code-based routing.
