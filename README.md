...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,042 | 🐛 1,058 | 🌐 JavaScript | 📅 2026-09-02
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,042 | 🐛 1,058 | 🌐 JavaScript | 📅 2026-09-02
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,905 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-02 - Svelte implementation of the IBM Carbon Design System.
...
* [Svelte UX](https://github.com/techniq/svelte-ux) ⭐ 1,127 | 🐛 116 | 🌐 Svelte | 📅 2026-09-02 - Large collection of components, actions, stores, and utilities to build highly interactive applications
...
* [AgentsKit](https://github.com/AgentsKit-io/agentskit) ⭐ 25 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-03 - Headless chat and agent components plus a store for building AI apps in Svelte, with a framework-agnostic core supporting streaming, tools, memory and RAG.
...
* [svelte-datagrid](https://github.com/revolist/svelte-datagrid) ⭐ 142 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-02 - Powerful data grid library based on [revogrid](https://rv-grid.com) with best features from Excel.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,301 | 🐛 521 | 🌐 TypeScript | 📅 2026-09-02 - Implementation of the lucide icon library for svelte applications.
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,935 | 🐛 88 | 🌐 TypeScript | 📅 2026-01-14 - Access thousands of icons as components on-demand universally.
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,643 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-02 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [moving icons](https://github.com/jis3r/icons) ⭐ 455 | 🐛 7 | 🌐 Svelte | 📅 2026-09-01 - A collection of beautifully crafted, animated Lucide icons.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,551 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-02 - A material design event calendar library.
...
* [Layer Cake](https://github.com/mhkeller/layercake) ⭐ 1,790 | 🐛 9 | 🌐 Svelte | 📅 2026-09-02 - A framework for mostly-reusable graphics with svelte
* [LayerChart](https://github.com/techniq/layerchart) ⭐ 1,309 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-27 - Large collection of composable Svelte components to build a wide range of visualizations, built upon Layer Cake
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,668 | 🐛 20 | 🌐 TypeScript | 📅 2026-07-18 - A component to transition, format, and localize numbers.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,658 | 🐛 765 | 🌐 TypeScript | 📅 2026-09-02 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,777 | 🐛 823 | 🌐 JavaScript | 📅 2026-09-03 - A CLI for creating a new SvelteKit project.
...
* [moving-icons](https://github.com/jis3r/icons) ⭐ 455 | 🐛 7 | 🌐 Svelte | 📅 2026-09-01 - beautifully crafted, moving icons. for svelte. 🧡
...
* [vest](https://github.com/ealush/vest) ⭐ 2,664 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-02 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [wuchale](https://github.com/K1DV5/wuchale) ⭐ 404 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-31 - Internationalization library that lets you just write your code, no function calls or other ceremonies needed.
...
* [svelte-fluent](https://github.com/nubolab-ffwd/svelte-fluent) ⭐ 113 | 🐛 12 | 🌐 Svelte | 📅 2026-09-02 - Components for easy integration of [Fluent](https://projectfluent.org/) localization.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 685 | 🐛 240 | 🌐 ReScript | 📅 2026-09-02 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 405 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-02 - An ESLint plugin for Svelte using AST.
