...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,087 | 🐛 1,068 | 🌐 JavaScript | 📅 2026-09-09
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,087 | 🐛 1,068 | 🌐 JavaScript | 📅 2026-09-09
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,906 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-09 - Svelte implementation of the IBM Carbon Design System.
...
* [Svelte UX](https://github.com/techniq/svelte-ux) ⭐ 1,127 | 🐛 118 | 🌐 Svelte | 📅 2026-09-09 - Large collection of components, actions, stores, and utilities to build highly interactive applications
...
* [ionic-svelte](https://github.com/Tommertom/svelte-ionic-app) ⭐ 83 | 🐛 0 | 🌐 Svelte | 📅 2025-11-16 - Svelte integration with Ionic's UI for mobile app development, including many starters.
* [AgentsKit](https://github.com/AgentsKit-io/agentskit) ⭐ 25 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-03 - Headless chat and agent components plus a store for building AI apps in Svelte, with a framework-agnostic core supporting streaming, tools, memory and RAG.
...
* [svelte-sonner](https://github.com/wobsoriano/svelte-sonner) ⭐ 1,293 | 🐛 20 | 🌐 Svelte | 📅 2026-08-14 - An opinionated toast component for Svelte.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,435 | 🐛 502 | 🌐 TypeScript | 📅 2026-09-09 - Implementation of the lucide icon library for svelte applications.
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,934 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-07 - Access thousands of icons as components on-demand universally.
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,670 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-08 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [moving icons](https://github.com/jis3r/icons) ⭐ 457 | 🐛 7 | 🌐 Svelte | 📅 2026-09-09 - A collection of beautifully crafted, animated Lucide icons.
...
* [svelte-icons-pack](https://github.com/leshak/svelte-icons-pack) ⭐ 72 | 🐛 1 | 🌐 TypeScript | 📅 2024-03-27 - Based on <https://github.com/react-icons/react-icons> ⭐ 12,654 | 🐛 242 | 🌐 TypeScript | 📅 2026-09-10.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,561 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-09 - A material design event calendar library.
...
* [LayerChart](https://github.com/techniq/layerchart) ⭐ 1,313 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-09 - Large collection of composable Svelte components to build a wide range of visualizations, built upon Layer Cake
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,687 | 🐛 20 | 🌐 TypeScript | 📅 2026-07-18 - A component to transition, format, and localize numbers.
* [File Viewer](https://github.com/flyfish-dev/file-viewer/tree/main/packages/components/svelte) ⭐ 2,280 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-09 - An offline-first Svelte component that previews 206 file extensions with lazy renderer presets and no server-side conversion.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,772 | 🐛 761 | 🌐 TypeScript | 📅 2026-09-09 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,796 | 🐛 798 | 🌐 JavaScript | 📅 2026-09-09 - A CLI for creating a new SvelteKit project.
* [saasstarter](https://github.com/CriticalMoments/CMSaasStarter) ⭐ 2,359 | 🐛 14 | 🌐 Svelte | 📅 2026-03-21 - A open source, fast, and free to host Svelte SaaS template.
...
* [microfolio](https://github.com/aker-dev/microfolio) ⭐ 144 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 - A static portfolio generator for creatives built with SvelteKit and Tailwind CSS 4, where content is just folders and Markdown files instead of a database, with interactive maps, EXIF metadata extraction and no tracking.
...
* [moving-icons](https://github.com/jis3r/icons) ⭐ 457 | 🐛 7 | 🌐 Svelte | 📅 2026-09-09 - beautifully crafted, moving icons. for svelte. 🧡
...
* [neodrag](https://github.com/PuruVJ/neodrag) ⭐ 2,451 | 🐛 77 | 🌐 TypeScript | 📅 2026-08-10 - One Draggable to rule them all 💍.
* sveltednd(<https://github.com/thisuxhq/sveltednd> ⭐ 605 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-01) - A lightweight, flexible drag and drop library for Svelte 5 applications.
...
* [@stitchapi/svelte](https://github.com/rejifald/StitchAPI/tree/main/packages/svelte) ⭐ 18 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-09 - Streaming-first StitchAPI bindings: typed, validated `stitchStore` / `stitchStreamStore` Svelte stores that re-render as response deltas arrive.
...
* [sveltekit-i18n](https://github.com/jarda-svoboda/sveltekit-i18n) ⭐ 576 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-09 - For integrating [i18n](https://www.npmjs.com/package/i18n) style localization in SvelteKit.
* [wuchale](https://github.com/K1DV5/wuchale) ⭐ 407 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-06 - Internationalization library that lets you just write your code, no function calls or other ceremonies needed.
...
* [svelte-fluent](https://github.com/nubolab-ffwd/svelte-fluent) ⭐ 113 | 🐛 12 | 🌐 Svelte | 📅 2026-09-09 - Components for easy integration of [Fluent](https://projectfluent.org/) localization.
...
* [sv-router](https://github.com/colinlienard/sv-router) ⭐ 213 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-09 - Type-safe SPA router with file-based or code-based routing.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 691 | 🐛 238 | 🌐 ReScript | 📅 2026-09-09 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 406 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-09 - An ESLint plugin for Svelte using AST.
...
* [PR Cockpit](https://github.com/theolundqvist/pr-cockpit) ⭐ 46 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-09 - An extremely fast GitHub for reviewing pull requests: PRs open in about 20 ms. Keyboard-first, with a CLI for coding agents. Svelte 5 runes UI over a Bun server.
