...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,159 | 🐛 1,086 | 🌐 JavaScript | 📅 2026-09-20
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,159 | 🐛 1,086 | 🌐 JavaScript | 📅 2026-09-20
...
* [MDSveX](https://github.com/pngwn/MDsveX) ⭐ 3,055 | 🐛 174 | 🌐 JavaScript | 📅 2026-09-20 - Preprocessor for MDX markdown.
...
* [modular-css](https://github.com/tivac/modular-css/tree/main/packages/svelte) ⭐ 291 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-18 - Preprocessor support for modular-css.
...
* [@nvl/sveltex](https://github.com/nvlang/sveltex) ⭐ 28 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-07 - Svelte + Markdown + LaTeX.
...
* [Melt UI](https://github.com/melt-ui/melt-ui) ⭐ 4,192 | 🐛 122 | 🌐 TypeScript | 📅 2025-09-30 - A collection of accessible, reusable, and composable headless component builders and utilities.
* [Svelte Material UI](https://github.com/hperrin/svelte-material-ui) ⭐ 3,443 | 🐛 72 | 🌐 SCSS | 📅 2026-08-31 - Material UI Components.
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,908 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-20 - Svelte implementation of the IBM Carbon Design System.
* [Smelte](https://github.com/matyunya/smelte) ⭐ 1,545 | 🐛 110 | 🌐 Svelte | 📅 2025-02-17 - UI framework with material components built with Tailwind CSS. *(pre-v5)*
* [Svelte UX](https://github.com/techniq/svelte-ux) ⭐ 1,126 | 🐛 118 | 🌐 Svelte | 📅 2026-09-19 - Large collection of components, actions, stores, and utilities to build highly interactive applications
...
* [M3 Svelte](https://github.com/KTibow/m3-svelte) ⭐ 460 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-20 - Robust component library implementing Material Design 3
...
* [Sveltestrap](https://github.com/sveltestrap/sveltestrap) ⭐ 215 | 🐛 15 | 🌐 Svelte | 📅 2026-01-28 - Bootstrap 4 & 5 components.
* [ionic-svelte](https://github.com/Tommertom/svelte-ionic-app) ⭐ 85 | 🐛 0 | 🌐 Svelte | 📅 2025-11-16 - Svelte integration with Ionic's UI for mobile app development, including many starters.
* [AgentsKit](https://github.com/AgentsKit-io/agentskit) ⭐ 26 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-19 - Headless chat and agent components plus a store for building AI apps in Svelte, with a framework-agnostic core supporting streaming, tools, memory and RAG.
...
* [svelte-table](https://github.com/dasDaniel/svelte-table) ⭐ 561 | 🐛 5 | 🌐 Svelte | 📅 2025-07-10 - A table implementation that allows sorting and filtering.
* [SVAR DataGrid](https://github.com/svar-widgets/grid) ⭐ 226 | 🐛 30 | 🌐 Svelte | 📅 2026-09-01 - A Svelte datagrid with in-cell editing, sorting, context menu, collapsible and frozen columns, tree data view, paging and virtual scrolling.
...
* [svelte-sonner](https://github.com/wobsoriano/svelte-sonner) ⭐ 1,293 | 🐛 21 | 🌐 Svelte | 📅 2026-08-14 - An opinionated toast component for Svelte.
* [svelte-french-toast](https://github.com/kbrgl/svelte-french-toast) ⭐ 1,060 | 🐛 36 | 🌐 Svelte | 📅 2026-05-15 - Buttery smooth toast notifications for Svelte, inspired by React Hot Toast. Lightweight, customizable, and beautiful by default.
* [@zerodevx/svelte-toast](https://github.com/zerodevx/svelte-toast) ⭐ 896 | 🐛 32 | 🌐 Svelte | 📅 2025-01-22 - Simple elegant toast notifications.
...
* [svelte-flex](https://github.com/himynameisdave/svelte-flex) ⭐ 82 | 🐛 14 | 🌐 TypeScript | 📅 2024-11-08 - A simple and reusable flexbox component for Svelte.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,628 | 🐛 461 | 🌐 TypeScript | 📅 2026-09-20 - Implementation of the lucide icon library for svelte applications.
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,938 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-11 - Access thousands of icons as components on-demand universally.
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,717 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-20 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [moving icons](https://github.com/jis3r/icons) ⭐ 458 | 🐛 6 | 🌐 Svelte | 📅 2026-09-15 - A collection of beautifully crafted, animated Lucide icons.
...
* [svelte-icons-pack](https://github.com/leshak/svelte-icons-pack) ⭐ 73 | 🐛 1 | 🌐 TypeScript | 📅 2024-03-27 - Based on <https://github.com/react-icons/react-icons> ⭐ 12,661 | 🐛 245 | 🌐 TypeScript | 📅 2026-09-18.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,579 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-19 - A material design event calendar library.
...
* [svelte-mapbox](https://github.com/beyonk-adventures/svelte-mapbox) ⭐ 368 | 🐛 3 | 🌐 Svelte | 📅 2026-08-01 - MapBox map and autocomplete components.
...
* [Layer Cake](https://github.com/mhkeller/layercake) ⭐ 1,792 | 🐛 1 | 🌐 Svelte | 📅 2026-09-09 - A framework for mostly-reusable graphics with svelte
* [LayerChart](https://github.com/techniq/layerchart) ⭐ 1,326 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-19 - Large collection of composable Svelte components to build a wide range of visualizations, built upon Layer Cake
...
* [SVAR Gantt Chart](https://github.com/svar-widgets/gantt) ⭐ 260 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-09 - An interactive, customizable Gantt chart component written in Svelte
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,704 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-20 - A component to transition, format, and localize numbers.
* [File Viewer](https://github.com/flyfish-dev/file-viewer/tree/main/packages/components/svelte) ⭐ 2,390 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-20 - An offline-first Svelte component that previews 206 file extensions with lazy renderer presets and no server-side conversion.
* [svelte-splitpanes](https://github.com/orefalo/svelte-splitpanes) ⭐ 478 | 🐛 17 | 🌐 Svelte | 📅 2026-09-16 - Full featured resizeable views panels.
...
* [svelte-streamdown](https://github.com/beynar/svelte-streamdown) ⭐ 105 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 - Port of [streamdown](https://streamdown.ai/). An all in one markdown renderer optimized for streaming with built in styles, math, mermaid, code highlighting support and more.
...
* [crd-ui](https://github.com/JuandaGarcia/crd-ui) ⭐ 23 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-19 - Credit and debit card visualization for payment forms and saved-card views, with live brand detection and a 3D flip.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,925 | 🐛 789 | 🌐 TypeScript | 📅 2026-09-19 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,821 | 🐛 806 | 🌐 JavaScript | 📅 2026-09-19 - A CLI for creating a new SvelteKit project.
* [saasstarter](https://github.com/CriticalMoments/CMSaasStarter) ⭐ 2,363 | 🐛 14 | 🌐 Svelte | 📅 2026-03-21 - A open source, fast, and free to host Svelte SaaS template.
...
* [microfolio](https://github.com/aker-dev/microfolio) ⭐ 143 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-10 - A static portfolio generator for creatives built with SvelteKit and Tailwind CSS 4, where content is just folders and Markdown files instead of a database, with interactive maps, EXIF metadata extraction and no tracking.
...
* [My SvelteKit Starter](https://github.com/moisesvalero/my-sveltekit-starter) ⭐ 1 | 🐛 8 | 🌐 Svelte | 📅 2026-09-08 - A production-ready SvelteKit boilerplate optimized for AI-assisted development, featuring Svelte 5 runes, Tailwind CSS v4, shadcn-svelte style components, i18n, and pre-configured agent instructions.

## Utilities

### Animations

* [ssgoi](https://github.com/meursyphus/ssgoi) ⭐ 972 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-20 - Native app-like page transitions with spring physics, 60fps on mobile, SSR-ready, and all modern browser support.
* [moving-icons](https://github.com/jis3r/icons) ⭐ 458 | 🐛 6 | 🌐 Svelte | 📅 2026-09-15 - beautifully crafted, moving icons. for svelte. 🧡
...
* [neodrag](https://github.com/PuruVJ/neodrag) ⭐ 2,452 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-10 - One Draggable to rule them all 💍.
* sveltednd(<https://github.com/thisuxhq/sveltednd> ⭐ 609 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-01) - A lightweight, flexible drag and drop library for Svelte 5 applications.

### Forms

* [vest](https://github.com/ealush/vest) ⭐ 2,662 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-21 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [@stitchapi/svelte](https://github.com/rejifald/StitchAPI/tree/main/packages/svelte) ⭐ 18 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-19 - Streaming-first StitchAPI bindings: typed, validated `stitchStore` / `stitchStreamStore` Svelte stores that re-render as response deltas arrive.
...
* [svelte-sound](https://github.com/Rajaniraiyn/svelte-sound) ⭐ 63 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-14 - Svelte Actions to play interaction sounds on target DOM events.
...
* [svelte-portal](https://github.com/romkor/svelte-portal) ⭐ 474 | 🐛 15 | 🌐 JavaScript | 📅 2024-07-20 - Component for rendering outside the DOM of parent component.
...
* [svelte-i18n](https://github.com/kaisermann/svelte-i18n) ⭐ 1,378 | 🐛 74 | 🌐 TypeScript | 📅 2024-10-21 - Internationalization library for Svelte.
* [sveltekit-i18n](https://github.com/jarda-svoboda/sveltekit-i18n) ⭐ 575 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-21 - For integrating [i18n](https://www.npmjs.com/package/i18n) style localization in SvelteKit.
* [wuchale](https://github.com/K1DV5/wuchale) ⭐ 409 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-19 - Internationalization library that lets you just write your code, no function calls or other ceremonies needed.
* [@tolgee/svelte](https://github.com/tolgee/tolgee-js/tree/main/packages/svelte) ⭐ 260 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-20 - Web-based localization tool enabling users to translate directly in the Svelte app they develop.
* [svelte-fluent](https://github.com/nubolab-ffwd/svelte-fluent) ⭐ 113 | 🐛 13 | 🌐 Svelte | 📅 2026-09-19 - Components for easy integration of [Fluent](https://projectfluent.org/) localization.
...
* [svelte-routing](https://github.com/EmilTholin/svelte-routing) ⭐ 2,052 | 🐛 40 | 🌐 JavaScript | 📅 2024-07-25 - A declarative Svelte routing library with SSR support.
* [svelte-spa-router](https://github.com/ItalyPaleAle/svelte-spa-router) ⭐ 1,609 | 🐛 21 | 🌐 Svelte | 📅 2026-08-23 - Optimized for Single Page Applications (SPA) with hash based routing and support for parameters.
...
* [sv-router](https://github.com/colinlienard/sv-router) ⭐ 216 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-20 - Type-safe SPA router with file-based or code-based routing.
...
* [Elder.js](https://github.com/elderjs/elderjs) ⭐ 2,122 | 🐛 47 | 🌐 TypeScript | 📅 2022-11-21 - Opinionated static site generator and web framework for Svelte built with SEO in mind. *(pre-v5)*
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 702 | 🐛 235 | 🌐 ReScript | 📅 2026-09-18 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [prettier-plugin-svelte](https://github.com/sveltejs/prettier-plugin-svelte) ⭐ 817 | 🐛 57 | 🌐 TypeScript | 📅 2026-07-21 - Format your components using prettier.
* [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 407 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-20 - An ESLint plugin for Svelte using AST.
* [svelte-check](https://www.npmjs.com/package/svelte-check) - Check your code.

### Test

* [@testing-library/svelte](https://github.com/testing-library/svelte-testing-library) ⭐ 667 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-07 - Simple and complete Svelte DOM testing utilities that encourage good testing practices.
...
* [PR Cockpit](https://github.com/theolundqvist/pr-cockpit) ⭐ 47 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-17 - An extremely fast GitHub for reviewing pull requests: PRs open in about 20 ms. Keyboard-first, with a CLI for coding agents. Svelte 5 runes UI over a Bun server.
* [Zephyr](https://github.com/Prismo-Studio/Zephyr) ⭐ 24 | 🐛 2 | 🌐 Rust | 📅 2026-08-11 - Open-source mod manager for PC games with built-in Archipelago multiworld randomizer support, built with Svelte 5 and Tauri 2.
