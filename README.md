...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,136 | 🐛 1,085 | 🌐 JavaScript | 📅 2026-09-19
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,136 | 🐛 1,085 | 🌐 JavaScript | 📅 2026-09-19
...
* [Melt UI](https://github.com/melt-ui/melt-ui) ⭐ 4,191 | 🐛 122 | 🌐 TypeScript | 📅 2025-09-30 - A collection of accessible, reusable, and composable headless component builders and utilities.
* [Svelte Material UI](https://github.com/hperrin/svelte-material-ui) ⭐ 3,443 | 🐛 72 | 🌐 SCSS | 📅 2026-08-31 - Material UI Components.
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,908 | 🐛 91 | 🌐 TypeScript | 📅 2026-09-20 - Svelte implementation of the IBM Carbon Design System.
...
* [M3 Svelte](https://github.com/KTibow/m3-svelte) ⭐ 460 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-01 - Robust component library implementing Material Design 3
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,607 | 🐛 459 | 🌐 TypeScript | 📅 2026-09-19 - Implementation of the lucide icon library for svelte applications.
...
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,712 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-19 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,577 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-19 - A material design event calendar library.
...
* [LayerChart](https://github.com/techniq/layerchart) ⭐ 1,325 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-19 - Large collection of composable Svelte components to build a wide range of visualizations, built upon Layer Cake
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,702 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-18 - A component to transition, format, and localize numbers.
* [File Viewer](https://github.com/flyfish-dev/file-viewer/tree/main/packages/components/svelte) ⭐ 2,370 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-20 - An offline-first Svelte component that previews 206 file extensions with lazy renderer presets and no server-side conversion.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,894 | 🐛 786 | 🌐 TypeScript | 📅 2026-09-19 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,820 | 🐛 806 | 🌐 JavaScript | 📅 2026-09-19 - A CLI for creating a new SvelteKit project.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,662 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-19 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [sveltekit-i18n](https://github.com/jarda-svoboda/sveltekit-i18n) ⭐ 575 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-18 - For integrating [i18n](https://www.npmjs.com/package/i18n) style localization in SvelteKit.
...
* [@tolgee/svelte](https://github.com/tolgee/tolgee-js/tree/main/packages/svelte) ⭐ 260 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-18 - Web-based localization tool enabling users to translate directly in the Svelte app they develop.
...
* [sv-router](https://github.com/colinlienard/sv-router) ⭐ 216 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-19 - Type-safe SPA router with file-based or code-based routing.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 701 | 🐛 235 | 🌐 ReScript | 📅 2026-09-18 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 407 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-18 - An ESLint plugin for Svelte using AST.
