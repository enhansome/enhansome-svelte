...
* [GitHub Repo](https://github.com/sveltejs/svelte) ⭐ 88,168 | 🐛 1,088 | 🌐 JavaScript | 📅 2026-09-21
* [Changelog](https://github.com/sveltejs/svelte/blob/master/packages/svelte/CHANGELOG.md) ⭐ 88,168 | 🐛 1,088 | 🌐 JavaScript | 📅 2026-09-21
...
* [MDSveX](https://github.com/pngwn/MDsveX) ⭐ 3,057 | 🐛 174 | 🌐 JavaScript | 📅 2026-09-20 - Preprocessor for MDX markdown.
...
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,908 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-22 - Svelte implementation of the IBM Carbon Design System.
...
* [AgentsKit](https://github.com/AgentsKit-io/agentskit) ⭐ 26 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21 - Headless chat and agent components plus a store for building AI apps in Svelte, with a framework-agnostic core supporting streaming, tools, memory and RAG.
...
* [lucide-svelte](https://github.com/lucide-icons/lucide) ⭐ 24,648 | 🐛 462 | 🌐 TypeScript | 📅 2026-09-21 - Implementation of the lucide icon library for svelte applications.
...
* [@thesvg/svelte](https://github.com/glincker/thesvg) ⭐ 2,718 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-21 - 5,600+ SVG brand and cloud icon components for Svelte. AWS, Azure, GCP, and 4,000+ brand logos.
...
* [svelte-icons-pack](https://github.com/leshak/svelte-icons-pack) ⭐ 73 | 🐛 1 | 🌐 TypeScript | 📅 2024-03-27 - Based on <https://github.com/react-icons/react-icons> ⭐ 12,665 | 🐛 245 | 🌐 TypeScript | 📅 2026-09-18.
...
* [@schedule-x/svelte](https://github.com/schedule-x/schedule-x) ⭐ 2,582 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-19 - A material design event calendar library.
...
* [number-flow](https://github.com/barvian/number-flow) ⭐ 7,707 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-20 - A component to transition, format, and localize numbers.
* [File Viewer](https://github.com/flyfish-dev/file-viewer/tree/main/packages/components/svelte) ⭐ 2,403 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-20 - An offline-first Svelte component that previews 206 file extensions with lazy renderer presets and no server-side conversion.
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite#readme) ⭐ 82,937 | 🐛 794 | 🌐 TypeScript | 📅 2026-09-21 - Generates scaffold for a vite + svelte app.
* [create-svelte](https://github.com/sveltejs/kit/tree/master/packages/create-svelte#readme) ⭐ 20,822 | 🐛 814 | 🌐 JavaScript | 📅 2026-09-21 - A CLI for creating a new SvelteKit project.
...
* [sveltekit-i18n](https://github.com/jarda-svoboda/sveltekit-i18n) ⭐ 575 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-21 - For integrating [i18n](https://www.npmjs.com/package/i18n) style localization in SvelteKit.
* [wuchale](https://github.com/K1DV5/wuchale) ⭐ 411 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-21 - Internationalization library that lets you just write your code, no function calls or other ceremonies needed.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 703 | 🐛 247 | 🌐 ReScript | 📅 2026-09-21 - Open-source AI coding agent that lives in your browser with click-to-edit and hot reload for Svelte apps.
...
* [PR Cockpit](https://github.com/theolundqvist/pr-cockpit) ⭐ 47 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-21 - An extremely fast GitHub for reviewing pull requests: PRs open in about 20 ms. Keyboard-first, with a CLI for coding agents. Svelte 5 runes UI over a Bun server.
